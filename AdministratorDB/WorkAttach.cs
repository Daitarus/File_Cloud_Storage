...
namespace AdministratorDB
{
    internal class WorkAttach
    {
        ...
        public static void AddAttach()
        {
            ...
            IRepositoryClient repositoryClient = new RepositoryClient(connectionString);
            IRepositoryFile repositoryFileC = new RepositoryFileC(connectionString);
            ...
            //add in DB
            IRepositoryClientFile repositoryFileAttach = new RepositoryFileAttach(connectionString);
        ...
        public static void DeleteAttach()
        {
            ...
            //delete attach
            RepositoryClientFile fileAttachR = new RepositoryFileAttach(connectionString);
